...
export default function Home() {
  return <div className={styles.event}>
    ...
    <Link href={'https://www.youtube.com/watch?v=cS5rc7X6io4'}><Image src='/img/event2021/IMG_9081.jpg' height={230} /></Link><br /><br />
    <Link href={'https://www.youtube.com/watch?v=cS5rc7X6io4'}>Watch the event</Link><br /><br /><br />
    <Link href={'/zip/2021photos.zip'}><Image src='/img/event2021/0Y1A7902.jpg' height={230} /></Link><br /><br />
